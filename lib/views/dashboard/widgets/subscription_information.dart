...
import 'package:fl_clash/widgets/subscription_info_viewlong.dart';

class SubscriptionInformation extends ConsumerWidget {
        ...
        child: Column(
		  ...
		  mainAxisSize: MainAxisSize.min,
			  ...
			  style: context.textTheme.bodyMedium?.toLight.adjustSize(1).copyWith(height: 1),
                    ...
                    const SizedBox(height: 10), // 添加6像素间距
                    if (subscriptionInfo != null) // 如果有订阅信息，显示 SubscriptionInfoView
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const SizedBox(height: 0), // 距离机场名称的间距（实际是流量与机场的间距）
                          SubscriptionInfoViewlong(
